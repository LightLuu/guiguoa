    ...
    <div class="app-container">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="关 键 字">
                <el-input style="width: 95%" v-model="searchObj.keyword" placeholder="问卷编号/标题/手机号码/姓名"></el-input>
              </el-form-item>
            </el-col>
            <!-- <el-col :span="8">
      ...
      <el-dialog title="查看问卷" :visible.sync="formDialogVisible" width="35%">
        ...
        <el-form ref="flashPromotionForm" label-width="150px" size="small" style="padding-right: 40px;">
          ...
          <!-- <el-form-item label={{  }}} style="margin-bottom: 0px;"></el-form-item> -->
        </el-form>
      ...
      >
        ...
        <el-table-column prop="processId" label="问卷编号" width="130"/>
        <el-table-column prop="name" label="标题" width="180"/>
        <el-table-column prop="operateUser" label="用户"/>
  ...
  export default {
    ...
    methods: {
      ...
      fetchData(page = 1) {
        ...
        //alert(111)
        api.getRecord(this.page, this.limit, this.searchObj).then(
          response => {
      ...
      show(row) {
        if(row.formValues == undefined){
          ...
          this.formValues = JSON.parse(row.formValues);
