<template>
  <div class="app-container">
    ...
    <el-dialog title="查看审批" :visible.sync="formDialogVisible" width="35%">
        <h3>审批详情</h3>
...
export default {
  data() {
    return {
      ...
      createTimes: [],
      formDialogVisible: false, // 查看显示表单
      formValues:{}
  ...
  methods: {
    ...
    show(row) {
      ...
      //this.$router.push('/processMgr/process/show/'+id)
       console.log(id)
    }
  }
}
